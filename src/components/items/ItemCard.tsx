...
export const ItemCard = ({ item, selected, onToggleSelect, onEdit, onDelete }: { item: Item; selected?: boolean; onToggleSelect?: (checked: boolean) => void; onEdit: () => void; onDelete: () => void }) => (
